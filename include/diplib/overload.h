...
#define DIP_OVLINT_HEAD( dtype ) \
   do { switch( dtype ) {

#define DIP_OVLINT_FOOT \
   default: DIP_THROW( dip::E::DATA_TYPE_NOT_SUPPORTED ); \
}} while( false )

#define DIP_OVLINT_BIN( assign_name, paramlist ) \
   case dip::DT_BIN      : assign_name< dip::bin >paramlist     ; break;

#define DIP_OVLINT_UINT( assign_name, paramlist ) \
...
#define DIP_OVLINT_SINT( assign_name, paramlist ) \
...
#define DIP_OVLINT_INTEGER( assign_name, paramlist ) \
   DIP_OVLINT_UINT( assign_name, paramlist ) \
   DIP_OVLINT_SINT( assign_name, paramlist )

#define DIP_OVLINT_INT_OR_BIN( assign_name, paramlist ) \
   DIP_OVLINT_BIN( assign_name, paramlist ) \
   DIP_OVLINT_INTEGER( assign_name, paramlist )

#define DIP_OVLINT_UNSIGNED( assign_name, paramlist ) \
   DIP_OVLINT_BIN( assign_name, paramlist ) \
   DIP_OVLINT_UINT( assign_name, paramlist )

#define DIP_OVLINT_SIGNED( assign_name, paramlist ) \
   DIP_OVLINT_SINT( assign_name, paramlist ) \
   DIP_OVLINT_FLOAT( assign_name, paramlist ) \
   DIP_OVLINT_COMPLEX( assign_name, paramlist )

#define DIP_OVLINT_REAL( assign_name, paramlist ) \
   DIP_OVLINT_INTEGER( assign_name, paramlist ) \
   DIP_OVLINT_FLOAT( assign_name, paramlist )

#define DIP_OVLINT_SIGNEDREAL( assign_name, paramlist ) \
   DIP_OVLINT_SINT( assign_name, paramlist ) \
   DIP_OVLINT_FLOAT( assign_name, paramlist )

#define DIP_OVLINT_NONCOMPLEX( assign_name, paramlist ) \
   DIP_OVLINT_BIN( assign_name, paramlist ) \
   DIP_OVLINT_REAL( assign_name, paramlist )

#define DIP_OVLINT_FLEX( assign_name, paramlist ) \
   DIP_OVLINT_FLOAT( assign_name, paramlist ) \
   DIP_OVLINT_COMPLEX( assign_name, paramlist )

#define DIP_OVLINT_FLEXBIN( assign_name, paramlist ) \
   DIP_OVLINT_BIN( assign_name, paramlist ) \
   DIP_OVLINT_FLEX( assign_name, paramlist )

#define DIP_OVLINT_NONBINARY( assign_name, paramlist ) \
   DIP_OVLINT_REAL( assign_name, paramlist ) \
   DIP_OVLINT_COMPLEX( assign_name, paramlist )

#define DIP_OVLINT_ALL( assign_name, paramlist ) \
   DIP_OVLINT_BIN( assign_name, paramlist ) \
   DIP_OVLINT_NONBINARY( assign_name, paramlist )
...
#define DIP_OVL_CALL_FLEX( fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_FLEX( fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_BINARY( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_BIN( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_UINT( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_UINT( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_SINT( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_SINT( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_FLOAT( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_FLOAT( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_COMPLEX( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_COMPLEX( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_INTEGER( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_INTEGER( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_INT_OR_BIN( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_INT_OR_BIN( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_UNSIGNED( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_UNSIGNED( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_SIGNED( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_SIGNED( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_REAL( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_REAL( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_SIGNEDREAL( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_SIGNEDREAL( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_NONCOMPLEX( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_NONCOMPLEX( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_FLEX( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_FLEX( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_FLEXBIN( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_FLEXBIN( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_NONBINARY( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_NONBINARY( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_CALL_ASSIGN_ALL( x, fname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_ALL( x = fname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_BINARY( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_BIN( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_UINT( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_UINT( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_SINT( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_SINT( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_FLOAT( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_FLOAT( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_COMPLEX( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_COMPLEX( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_INTEGER( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_INTEGER( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_INT_OR_BIN( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_INT_OR_BIN( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_UNSIGNED( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_UNSIGNED( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_SIGNED( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_SIGNED( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_REAL( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_REAL( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_SIGNEDREAL( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_SIGNEDREAL( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_NONCOMPLEX( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_NONCOMPLEX( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_FLEX( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_FLEX( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_FLEXBIN( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_FLEXBIN( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_NONBINARY( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_NONBINARY( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
...
#define DIP_OVL_NEW_ALL( x, cname, paramlist, dtype ) \
   DIP_OVLINT_HEAD( dtype ) \
   DIP_OVLINT_ALL( x = ( decltype( x )) new cname, paramlist ) \
   DIP_OVLINT_FOOT
